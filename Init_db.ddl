...
CREATE SEQUENCE seq_osoby START WITH 1 NOCACHE ORDER;
...
CREATE SEQUENCE seq_studenci START WITH 1000 NOCACHE ORDER;

CREATE OR REPLACE TRIGGER studenci_id_trg BEFORE
    INSERT ON studenci
    FOR EACH ROW
    WHEN ( new.id IS NULL )
BEGIN
